    ...
    <div class="card">
      ...
      <form method="POST" action="{{ route('estoques.update', $estoque) }}" accept-charset="UTF-8">
        ...
        <div class="card-body">
          <div class="form-group">
            ...
            <input id="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name"
              value="{{ old('name', $estoque->name) }}" required>
          ...
          <div class="form-group">
            ...
            <textarea id="description" class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}"
              name="description" rows="4">{{ old('description', $estoque->description) }}</textarea>
        ...
        <div class="card-footer">
          ...
          @can('delete', $estoque)
          <a href="{{ route('estoques.edit', [$estoque, 'action' => 'delete']) }}" id="del-estoque-{{ $estoque->id }}"
