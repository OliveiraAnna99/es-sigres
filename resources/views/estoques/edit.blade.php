    ...
    <form method="POST" action="{{ route('estoques.update', $estoque) }}" accept-charset="UTF-8">
      ...
      <div class="cardBody">
        <div class="formGroup">
          ...
          <input id="item" type="text" class="form-control{{ $errors->has('item') ? ' is-invalid' : '' }}" name="item" value="{{ $estoque->item }}" required>
        ...
        <div class="formGroup">
          ...
          <input id="quant" type="text" class="form-control{{ $errors->has('quant') ? ' is-invalid' : '' }} " name="quant" value="{{ $estoque->quant }}" required>
        ...
        <div class="formGroup">
          ...
          <input id="date" type="text" class="form-control{{ $errors->has('date') ? ' is-invalid' : '' }} " name="date" value="{{ $estoque->date }}" required>
